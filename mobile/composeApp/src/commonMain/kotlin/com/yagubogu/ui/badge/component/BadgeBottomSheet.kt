...
import yagubogu.composeapp.generated.resources.badge_progress_rate
import yagubogu.composeapp.generated.resources.badge_register_main_badge
...
private fun BadgeDescriptionHeader(
    ...
    Row {
        ...
        Text(
            text = stringResource(Res.string.badge_achieved_rate_message),
...
private fun AcquiredBadgeContent(
            ...
            text =
                stringResource(
                    if (isRepresentativeBadge) {
                        Res.string.badge_already_used_badge
                    } else {
                        Res.string.badge_register_main_badge
                    },
                ),
    ...
    Text(
        text =
            stringResource(
                Res.string.badge_achieved_date,
