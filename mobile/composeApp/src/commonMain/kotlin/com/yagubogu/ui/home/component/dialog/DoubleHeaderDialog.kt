...
import yagubogu.composeapp.generated.resources.home_double_header_game
import yagubogu.composeapp.generated.resources.home_double_header_message
import yagubogu.composeapp.generated.resources.home_double_header_title
    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(Res.string.home_check_in_stadium_emoji),
                    style = TextStyle(fontSize = 48.sp),
                )
                Spacer(modifier = Modifier.height(20.dp))

                Text(
                    text = stringResource(Res.string.home_double_header_title, stadium.name),
                ...
                Text(
                    text = stringResource(Res.string.home_double_header_message),
                ...
                Row(
                    ...
                    stadium.gameIds.forEachIndexed { index: Int, gameId: Long ->
                        Button(
                            ...
                            Text(
                                text = stringResource(Res.string.home_double_header_game, index + 1),
