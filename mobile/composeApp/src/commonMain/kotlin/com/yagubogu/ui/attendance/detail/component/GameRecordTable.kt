...
import yagubogu.composeapp.generated.resources.attendance_history_balls
import yagubogu.composeapp.generated.resources.attendance_history_errors
import yagubogu.composeapp.generated.resources.attendance_history_hits
import yagubogu.composeapp.generated.resources.attendance_history_team_record
...
fun GameRecordTable(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        // 헤더
        GameRecordRow(
            title = stringResource(Res.string.attendance_history_team_record),
        ...
        // 안타
        GameRecordRow(
            title = stringResource(Res.string.attendance_history_hits),
        ...
        // 실책
        GameRecordRow(
            title = stringResource(Res.string.attendance_history_errors),
        ...
        // 사사구
        GameRecordRow(
            title = stringResource(Res.string.attendance_history_balls),
