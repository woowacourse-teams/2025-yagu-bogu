...
import yagubogu.composeapp.generated.resources.all_ranking
import yagubogu.composeapp.generated.resources.all_score_first_float
import yagubogu.composeapp.generated.resources.all_win_rate
import yagubogu.composeapp.generated.resources.ic_close
import yagubogu.composeapp.generated.resources.profile_check_in_counts
import yagubogu.composeapp.generated.resources.profile_latest_check_in_date
import yagubogu.composeapp.generated.resources.profile_ranking_all
import yagubogu.composeapp.generated.resources.profile_ranking_rank
import yagubogu.composeapp.generated.resources.profile_ranking_within_team
import yagubogu.composeapp.generated.resources.profile_register_date
import yagubogu.composeapp.generated.resources.profile_representative_badge_content_description
import yagubogu.composeapp.generated.resources.profile_victory_fairy_ranking
import yagubogu.composeapp.generated.resources.profile_victory_fairy_ranking_emoji
import yagubogu.composeapp.generated.resources.profile_victory_fairy_score
import yagubogu.composeapp.generated.resources.profile_victory_fairy_score_emoji
import yagubogu.composeapp.generated.resources.profile_win_draw_lose
import yagubogu.composeapp.generated.resources.profile_winning_percentage
    ...
    Box(
        ...
        Box(
            ...
            Row(
                ...
                Column {
                    Text(
                        text = stringResource(Res.string.all_fan, memberProfile.favoriteTeam),
                ...
                memberProfile.representativeBadgeImageUrl?.let { badgeImageUrl: String ->
                    AsyncImage(
                        model = badgeImageUrl,
                        contentDescription = stringResource(Res.string.profile_representative_badge_content_description),
...
private fun RankingText(
    ...
    Row {
        Text(
            text = stringResource(Res.string.profile_ranking_all),
        ...
        Text(
            text = stringResource(Res.string.profile_ranking_rank),
            style = PretendardRegular,
            fontSize = 10.sp,
            color = Gray500,
        )
        ...
        Text(
            text = stringResource(Res.string.profile_ranking_within_team),
            style = PretendardRegular,
            fontSize = 10.sp,
            color = Gray500,
        )
...
private fun VictoryFairyStatsRow(
    ...
    Row(
        ...
        StatItem(
            title = stringResource(Res.string.profile_victory_fairy_ranking),
            value =
                if (memberProfile.victoryFairyRanking != null) {
                    stringResource(Res.string.all_ranking, memberProfile.victoryFairyRanking)
                } else {
                    null
                },
            emoji = stringResource(Res.string.profile_victory_fairy_ranking_emoji),
        ...
        StatItem(
            ...
            emoji = stringResource(Res.string.profile_victory_fairy_score_emoji),
            modifier = Modifier.weight(1f),
        )
    }
}
...
private fun CheckInStatsRow(
    ...
    Row(
        ...
        StatItem(
            title = stringResource(Res.string.profile_check_in_counts),
        ...
        StatItem(
            title = stringResource(Res.string.profile_win_draw_lose),
...
private fun DatesRow(
    ...
    Row(
        ...
        StatItem(
            title = stringResource(Res.string.profile_register_date),
        ...
        StatItem(
            title = stringResource(Res.string.profile_latest_check_in_date),
            value =
